...
* The expected count of leprosy bacilli at follow-up in the placebo group is $e^{\beta_{1}} = e^{2.37} = 10.73$
<!-- <div class = "green"> -->
...
* $e^{\beta_2+\beta_{3}}$ is the rate ratio of leprosy bacilli, comparing follow-up period to baseline in drug A
* $e^{\beta_2+\beta_{4}}$ is the rate ratio of leprosy bacilli, comparing follow-up period to baseline in drug B
...
```{r}
### wald statistic for H0:beta3=beta4
